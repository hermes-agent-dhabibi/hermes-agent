...
def _run_cleanup():
    ...
    try:
        ...
        _invoke_hook("on_session_finalize", session_id=_active_agent_ref.session_id if _active_agent_ref else None, platform="cli", chat_id="cli", thread_id=None, user_id=None)
    except Exception:
        pass
    try:
